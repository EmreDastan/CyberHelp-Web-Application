...
<head>
    ...
    <title>Offensive Security Order - CyberHelp</title>
...
<body>
    ...
    <section class="order-container">
        <h2 class="order-heading">Order Offensive Security</h2>

        <!-- Order form -->
        <form class="order-form" action="process-offensive-order.php" method="post">
