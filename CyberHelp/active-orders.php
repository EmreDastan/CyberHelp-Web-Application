...
<head>
    ...
    <title>Active Orders - CyberHelp</title>
...
<body>
    ...
    <section class="active-orders-container">
        <h2 class="active-orders-heading">Your Active Orders</h2>
...
$stmt->bind_param('iii', $_SESSION['id'], $offset, $perPage);
$stmt->execute();
...
$stmt->close();
        ...
        <!-- Back to Dashboard Button -->
        <a href="customer-dashboard.php" class="back-to-dashboard-btn">
            Back to Dashboard
        </a>
    </section>
