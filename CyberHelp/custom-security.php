...
<head>
    ...
    <title>Custom Security Order - CyberHelp</title>
...
<body>
    ...
    <section class="order-container">
        <h2 class="order-heading">Order Custom Security</h2>
        <h3 style="font-size: 16px; color: white;">Give more details for this solution.</h3>

        <!-- Order form -->
        <form class="order-form" action="process-custom-order.php" method="post">
