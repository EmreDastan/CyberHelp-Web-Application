...
<head>
    ...
    <title>Admin Login - CyberHelp</title>
...
<body>
    ...
    <div class="login-container">
        ...
        <!-- Login form -->
        <form class="login-form" action="process-admin-login.php" method="post">
            <div class="form-group">
                <label for="adminUsername">Username</label>
                <input type="text" name="adminUsername" id="adminUsername" placeholder="Enter your username" required>
            </div>
            <div class="form-group">
    ...
    <script src="https://stackpath.com/cdn.jsdelivr.net/npm/bootstrap@4.5.0/js/bootstrap.min.js"></script>
